...
class SerialToolUI(object):
    ...
    def create_frm_left_serial_set(self):
        ...
        self.frm_left_combobox_baudrate = tkinter.ttk.Combobox(self.frm_left_serial_set,
                                                       width=15,
                                                       values=baudrate_list)
        self.frm_left_combobox_parity = tkinter.ttk.Combobox(self.frm_left_serial_set,
                                                       width=15,
                                                       values=parity_list)
        self.frm_left_combobox_databit = tkinter.ttk.Combobox(self.frm_left_serial_set,
                                                       width=15,
                                                       values=bytesize_list)
        self.frm_left_combobox_stopbit = tkinter.ttk.Combobox(self.frm_left_serial_set,
                                                       width=15,
